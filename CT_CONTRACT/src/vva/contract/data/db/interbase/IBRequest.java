...
public class IBRequest{
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
     ...
     * @STORED_PROCEDURE_INTERBASE
     * GET_NUMPP_DOGOVORA_FILTER (
    								F_FULLNAMEDOG,
    								F_RESULTDOG,
    								F_RIGHTHOLDER,
    								F_SUBDOG_INPROCESS,
    								F_SUBDOG_PRED,
    								F_PERFORMER,
    								F_COUNTERAGENT_FNAME
    							)
     */
    public void getAllContractsWithFilter_IB(String start,String limit,
    										String  F_FULLNAMEDOG,
    										String  F_RESULTDOG,
    										String  F_RIGHTHOLDER,
    										String  F_SUBDOG_INPROCESS,
    										String  F_SUBDOG_PRED,
    										String  F_PERFORMER,
    										String  F_COUNTERAGENT_FNAME
    		) throws SQLException, UnsupportedEncodingException{
    	//  public void getAllContracts_IB(String start,String limit) throws SQLException{
    	
    	  if (F_FULLNAMEDOG==null) F_FULLNAMEDOG="";
    	  if (F_RESULTDOG==null) F_RESULTDOG="";
    	  if (F_RIGHTHOLDER==null) F_RIGHTHOLDER="";
    	  if (F_SUBDOG_INPROCESS==null) F_SUBDOG_INPROCESS="";
    	  if (F_SUBDOG_PRED==null)F_SUBDOG_PRED ="";
    	  if (F_PERFORMER==null) F_PERFORMER="";
    	  if (F_COUNTERAGENT_FNAME==null) F_COUNTERAGENT_FNAME="";
    	
    	String sql="SELECT * FROM GET_NUMPP_DOGOVORA_FILTER("
    			+ "											'"+F_FULLNAMEDOG.getBytes("windows-1251")+"',"
    			+ "											'"+F_RESULTDOG+"',"
    			+ "											'"+F_RIGHTHOLDER+"',"
    			+ "											'"+F_SUBDOG_INPROCESS+"',"
    			+ "											'"+F_SUBDOG_PRED+"',"
    			+ "											'"+F_PERFORMER+"',"
    			+ "											'"+F_COUNTERAGENT_FNAME+"'"
    			+ "										    ) where GET_NUMPP_DOGOVORA_FILTER.i>"+start+" and GET_NUMPP_DOGOVORA_FILTER.i<=("+start+"+"+limit+")"
    			+ " ORDER BY i asc";
    ...
    public void getAllPerformerWithFilter_IB(String start,String limit) throws SQLException{
    	//  public void getAllContracts_IB(String start,String limit) throws SQLException{
    	String sql=" SELECT "
    			+ " 	  	GET_NUMPP_DOGOVORA.id_dog id_dog, "
    			+ "			dog_performer.performer performer "
