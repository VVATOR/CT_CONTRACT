...
Ext.onReady(function() {
    ...
    var grid1 = Ext.create('Ext.grid.Panel', {
    	store : store,
        columns: [
            {text: "SUMMA", flex: 1, dataIndex: 'SUMMA'},
            {text: "ID_DOG", renderer: Ext.util.Format.usMoney, dataIndex: 'ID_DOG'},
            {text: "CURRENCY", dataIndex: 'CURRENCY'},
            {text: "NAMEDOG", dataIndex: 'NAMEDOG'},
            {text: "REG_DATE", renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'REG_DATE'}
        ],
        width: 600,
        height: 300,
        plugins: [{
            ptype: 'rowexpander',
            rowBodyTpl : [
                '<p><b>Company:</b> {REG_DATE}</p><br>',
                '<p><b>Summary:</b> {SUMMA}</p>'
            ]
        }],
        collapsible: true,
        animCollapse: false,
